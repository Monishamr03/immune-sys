...
var toxicityScanBtn = document.getElementById("toxicity-scan-btn");
var raidScanBtn = document.getElementById("raid-scan-btn");
var burnoutScanBtn = document.getElementById("burnout-scan-btn");
var healthScore = document.getElementById("health-score");
var healthStatus = document.getElementById("health-status");
var flaggedPosts = document.getElementById("flagged-posts");
var postsToday = document.getElementById("posts-today");
var newMembers = document.getElementById("new-members");
var highRiskCount = document.getElementById("high-risk-count");
var analyzedCount = document.getElementById("analyzed-count");
var toxicPostsContainer = document.getElementById("toxic-posts-container");
var raidRiskScore = document.getElementById("raid-risk-score");
var recentCommentsEl = document.getElementById("recent-comments");
var uniqueAuthorsEl = document.getElementById("unique-authors");
var newAccountActivityEl = document.getElementById("new-account-activity");
var raidStatusContainer = document.getElementById("raid-status-container");
...
function updateHealthStatus(score) {
  if (score >= 80) {
    ...
    healthStatus.textContent = "\u{1F6A8} Critical";
...
scanBtn.addEventListener("click", async () => {
  ...
  setTimeout(() => {
    scanBtn.textContent = "\u{1F50D} Run Health Scan";
    scanBtn.style.opacity = "1";
  }, 2e3);
});
toxicityScanBtn.addEventListener("click", async () => {
  toxicityScanBtn.textContent = "\u{1F504} Analyzing...";
...
raidScanBtn.addEventListener("click", async () => {
  raidScanBtn.textContent = "\u{1F504} Scanning...";
  ...
  setTimeout(() => {
    raidScanBtn.textContent = "\u{1F6A8} Run Raid Scan";
    raidScanBtn.style.opacity = "1";
  }, 2e3);
});
burnoutScanBtn.addEventListener("click", async () => {
  burnoutScanBtn.textContent = "\u{1F504} Scanning...";
  ...
  setTimeout(() => {
    burnoutScanBtn.textContent = "\u{1F62E}\u200D\u{1F4A8} Run Burnout Scan";
