...
export class NotificationsClient {
     ...
     */
    async requestShowGameBadge(options) {
        return await __classPrivateFieldGet(this, _NotificationsClient_instances, "a", _NotificationsClient_plugin_get).ShowGameBadge(options, __classPrivateFieldGet(this, _NotificationsClient_instances, "a", _NotificationsClient_metadata_get));
    }
    /**
    ...
    async dismissGameBadge() {
        return await __classPrivateFieldGet(this, _NotificationsClient_instances, "a", _NotificationsClient_plugin_get).DismissGameBadge({}, __classPrivateFieldGet(this, _NotificationsClient_instances, "a", _NotificationsClient_metadata_get));
    }
    /**
    ...
    async getGameBadgeStatus() {
        return await __classPrivateFieldGet(this, _NotificationsClient_instances, "a", _NotificationsClient_plugin_get).GetGameBadgeStatus({}, __classPrivateFieldGet(this, _NotificationsClient_instances, "a", _NotificationsClient_metadata_get));
    }
}
