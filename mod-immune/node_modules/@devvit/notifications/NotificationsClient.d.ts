...
import type { EnqueueOptions, EnqueueResponse, ListOptedInUsersIteratorOptions, ListOptedInUsersOptions, ListOptedInUsersResponse, OptInCurrentUserResponse, OptOutCurrentUserResponse, ShowGameBadgeRequest } from './types/notifications.js';
export declare class NotificationsClient {
     ...
     */
    enqueue(options: EnqueueOptions): Promise<EnqueueResponse>;
    /**
     * Opt the current user in to receiving push notifications.
     * @returns A promise that resolves when the operation is complete
     */
    optInCurrentUser(): Promise<OptInCurrentUserResponse>;
    /**
     * Opt the current user out of receiving push notifications.
     * @returns A promise that resolves when the operation is complete
     */
    optOutCurrentUser(): Promise<OptOutCurrentUserResponse>;
    /**
     ...
     */
    listOptedInUsers(options: ListOptedInUsersOptions): Promise<ListOptedInUsersResponse>;
    /**
     ...
     */
    isOptedIn(userId: T2): Promise<boolean>;
    /**
     ...
     */
    listOptedInUsersIterator(options?: ListOptedInUsersIteratorOptions): AsyncIterableIterator<string>;
    /**
     ...
     */
    requestShowGameBadge(options: ShowGameBadgeRequest): Promise<{
        success: boolean;
