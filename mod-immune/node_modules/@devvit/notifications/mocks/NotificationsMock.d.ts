...
import { type DismissGameBadgeRequest, type DismissGameBadgeResponse, type GetGameBadgeStatusRequest, type GetGameBadgeStatusResponse, type ShowGameBadgeRequest, type ShowGameBadgeResponse } from '@devvit/protos/types/devvit/plugin/notifications/gamesdrawerbadge_msg.js';
...
export declare class NotificationsPluginMock implements Notifications {
    ...
    ShowGameBadge(request: ShowGameBadgeRequest, _metadata?: Metadata): Promise<ShowGameBadgeResponse>;
    DismissGameBadge(_request: DismissGameBadgeRequest, _metadata?: Metadata): Promise<DismissGameBadgeResponse>;
    GetGameBadgeStatus(_request: GetGameBadgeStatusRequest, _metadata?: Metadata): Promise<GetGameBadgeStatusResponse>;
}
