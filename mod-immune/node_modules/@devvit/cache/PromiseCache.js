...
_PromiseCache_redis = new WeakMap(), _PromiseCache_localCache = new WeakMap(), _PromiseCache_clock = new WeakMap(), _PromiseCache_randomizer = new WeakMap(), _PromiseCache_instances = new WeakSet(), _PromiseCache_localCachedAnswer = function _PromiseCache_localCachedAnswer(key) {
    const localKey = __classPrivateFieldGet(this, _PromiseCache_instances, "m", _PromiseCache_localKey).call(this, key);
    const val = __classPrivateFieldGet(this, _PromiseCache_localCache, "f")[localKey];
    if (val) {
        ...
        if (expired || hasRetryableError) {
            delete __classPrivateFieldGet(this, _PromiseCache_localCache, "f")[localKey];
            return undefined;
        }
        else {
            return _unwrap(val);
...
async function _PromiseCache_updateCache(key, entry, closure, ttlMs) {
    ...
    __classPrivateFieldGet(this, _PromiseCache_localCache, "f")[localKey] = entry;
...
}, _PromiseCache_localKey = function _PromiseCache_localKey(key) {
