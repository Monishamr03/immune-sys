 ...
 * @experimental
 */
export declare function getWebViewMode(): WebViewMode;
/**
 ...
 * ```
 */
export declare function requestExpandedMode(event: MouseEvent, entry: string): void;
/**
 ...
 * ```
 */
export declare function exitExpandedMode(event: MouseEvent): void;
/**
